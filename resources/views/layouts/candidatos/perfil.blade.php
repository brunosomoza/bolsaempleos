                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="pf-field">
                                                <select name="industria" id="industria" data-placeholder="_Sector Empresarial" class="chosen">
                                                    ...
                                                    <option value="26">26) Forestal</option>
                                                    <option value="27">27) Ganadería</option>
                                                    <option value="28">28) Gastronomía</option>
                                                    <option value="29">29) Gobierno</option>
                                                    <option value="30">30) Higiene y Perfumería</option>
                                                    <option value="31">31) Holding</option>
                                                    <option value="32">32) Hotelería</option>
                                                    <option value="33">33) Imprenta</option>
                                                    <option value="34">34) Información e Investigación</option>
                                                    <option value="35">35) Informática / Tecnología</option>
                                                    <option value="36">36) Inmobiliaria</option>
                                                    <option value="37">37) Internet</option>
                                                    <option value="38">38) Jurídica</option>
                                                    <option value="39">39) Laboratorio</option>
                                                    <option value="40">40) Manufactura</option>
                                                    <option value="41">41) Medios</option>
                                                    <option value="42">42) Minería / Petróleo / Gas</option>
                                                    <option value="43">43) ONGs</option>
                                                    <option value="44">44) Otra</option>
                                                    <option value="45">45) Papelera</option>
                                                    <option value="46">46) Pesca</option>
                                                    <option value="47">47) Petroquímica</option>
                                                    <option value="48">48) Plásticos</option>
                                                    <option value="49">49) Publicidad / Marketing / RRPP</option>
                                                    <option value="50">50) Química</option>
                                                    <option value="51">51) Retail</option>
                                                    <option value="52">52) Salud</option>
                                                    <option value="53">53) Seguros</option>
                                                    <option value="54">54) Servicios</option>
                                                    <option value="55">55) Siderurgia</option>
                                                    <option value="56">56) Supermercado / Hipermercado</option>
                                                    <option value="57">57) Tabacalera</option>
                                                    <option value="58">58) Telecomunicaciones</option>
                                                    <option value="59">59) Textil</option>
                                                    <option value="60">60) Transportadora</option>
                                                    <option value="61">61) Transporte</option>
                                                    <option value="62">62) Turismo</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
