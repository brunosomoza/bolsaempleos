    ...
    <div class="responsive-header">
        ...
        <div class="responsive-opensec">
            <div class="btn-extars">
                <a href="index.html#" title="" class="post-job-btn"><i class="la la-plus"></i>Post Jobs</a>
            ...
            <div class="responsivemenu">
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="index.html#" title="">Employers</a>
                        <ul>
                            ...
                            <li class="menu-item-has-children">
                                <a href="index.html#" title="">Employer Dashboard</a>
                                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="index.html#" title="">Candidates</a>
                        <ul>
                            ...
                            <li class="menu-item-has-children">
                                <a href="index.html#" title="">Candidates Dashboard</a>
                                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="index.html#" title="">Pages</a>
                        <ul>
                    ...
                    <div class="col-lg-3 column">
                        <div class="widget">
                            <div class="download_widget">
                                <a href="index.html#" title=""><img src="images/resource/dw1.png" alt="" /></a>
                                <a href="index.html#" title=""><img src="images/resource/dw2.png" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="account-popup-area signin-popup-box">
    <div class="account-popup">
        ...
        <form>
            ...
            <a href="index.html#" title="">Forgot Password?</a>
