                    ...
                    <div class="col-lg-8 column">
                        <div class="job-single-sec">
                            <div class="job-single-head2">
                                <div class="job-title2"><h3>{{$trabajo->title}}</h3><span class="job-is ft">Full time</span><i class="la la-heart-o"></i></div>
                                <ul class="tags-jobs">
                                    <li><i class="la la-map-marker"></i> Sacramento, California</li>
                                    <li><i class="la la-money"></i> Monthly Salary : <span>$3000 - $5000</span></li>
                                    <li><i class="la la-calendar-o"></i> Post Date: {{$trabajo->created_at}}</li>
                                </ul>
                            ...
                            <div class="share-bar">
                                <span>Share</span><a href="job_single2.html#" title="" class="share-fb"><i class="fa fa-facebook"></i></a><a href="job_single2.html#" title="" class="share-twitter"><i class="fa fa-twitter"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 column">
                        <div class="job-single-head style2">
                            ...
                            <div class="job-head-info">
                                ...
                                <p><i class="la la-envelope-o"></i> <a href="../../cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="c7a6abaee9b3b2a1a6a987ada8a5afb2a9b3e9a4a8aa">[email&#160;protected]</a></p>
                            </div>
                            <a href="job_single2.html#" title="" class="apply-job-btn"><i class="la la-paper-plane"></i>Apply for job</a>
                            <a href="job_single2.html#" title="" class="apply-job-linkedin"><i class="fa fa-linkedin"></i>Apply with Linkedin</a>
                            <a href="job_single2.html#" title="" class="viewall-jobs">View all Jobs</a>
                        </div><!-- Job Head -->
                    </div>
                </div>
            </div>
